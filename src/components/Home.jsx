...
const Home = () => {
  ...
  return (
    <div
      name="Home"
      className="relative pt-16 min-h-screen w-full flex items-center hero-gradient bg-pattern overflow-hidden"
    >
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large gradient orbs */}
        <div className="absolute top-20 left-10 w-72 h-72 md:w-96 md:h-96 bg-gradient-to-br from-cyan-500/20 via-blue-600/15 to-purple-700/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 md:w-[500px] md:h-[500px] bg-gradient-to-br from-purple-600/15 via-indigo-700/10 to-cyan-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 md:w-[700px] md:h-[700px] bg-gradient-to-br from-blue-600/10 via-cyan-500/15 to-purple-600/10 rounded-full blur-3xl animate-pulse delay-500"></div>
        
        {/* Geometric shapes - hidden on mobile */}
        <div className="hidden md:block absolute top-32 right-32 w-20 h-20 border-2 border-cyan-500/30 rotate-45 animate-spin" style={{animationDuration: '20s'}}></div>
        <div className="hidden md:block absolute bottom-32 left-32 w-16 h-16 border-2 border-blue-500/30 rotate-12 animate-bounce"></div>
        
        {/* Matrix-style lines - hidden on mobile */}
        <div className="hidden lg:block absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-cyan-500/20 to-transparent"></div>
        <div className="hidden lg:block absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-blue-500/20 to-transparent"></div>
      </div>
      ...
      <div className="section gap-8 md:gap-12 lg:gap-16 md:justify-between items-center md:flex-row-reverse relative z-10">
          ...
          <AnimatedWrapper delay={0.8} animateFrom="right">
            <div className="relative group">
              ...
              <img
                ...
                className="relative rounded-full w-full border-4 border-gray-700/50 dark:border-gray-600/50 shadow-2xl float-animation hover:scale-105 transition-transform duration-500 z-10"
              />
        ...
        {/* Content Section */}
        <div className="flex flex-col gap-6 md:gap-8 justify-center text-gray-100 dark:text-gray-100 w-full md:w-3/5 text-center md:text-left">
          
          <AnimatedWrapper delay={0.2}>
            <div className="space-y-3 md:space-y-4">
              <p className="text-base md:text-lg font-semibold text-cyan-400 dark:text-cyan-400 tracking-wide flex items-center justify-center md:justify-start gap-2">
          ...
          <AnimatedWrapper delay={0.35}>
            <div className="space-y-3 md:space-y-4">
              <p className="text-lg xs:text-xl md:text-2xl lg:text-3xl font-bold text-gray-200 dark:text-gray-200">
                Specializing in
              </p>
              <div className="text-xl xs:text-2xl md:text-3xl lg:text-4xl font-bold text-cyan-400 dark:text-cyan-400 min-h-[3rem] md:min-h-[4rem] neon-text">
                <TypeAnimation
                  sequence={interest}
                  speed={50}
                  wrapper="span"
              ...
              <p className="text-base md:text-lg text-gray-300 dark:text-gray-300 max-w-2xl leading-relaxed mx-auto md:mx-0">
          ...
          <AnimatedWrapper delay={0.4}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 my-6 md:my-8">
              {stats.map((stat, index) => (
                <div key={index} className="group text-center p-4 md:p-6 content-card hover:border-cyan-500/50 transition-all duration-300">
                  <div className="text-2xl md:text-3xl mb-2 group-hover:animate-bounce">{stat.icon}</div>
                  <div className="text-2xl md:text-3xl font-bold text-cyan-400 dark:text-cyan-400 neon-text">{stat.value}</div>
                  <div className="text-xs md:text-sm text-gray-300 dark:text-gray-300 font-medium">{stat.label}</div>
                </div>
              ))}
            </div>
          </AnimatedWrapper>
          ...
          <AnimatedWrapper delay={0.55}>
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 pt-4 md:pt-6 justify-center md:justify-start">
              <Link
                ...
                smooth
                duration={500}
                className="btn-primary group cursor-pointer inline-flex items-center justify-center gap-3 w-full sm:w-fit"
              >
              ...
              <Link
                ...
                smooth
                duration={500}
                className="btn-secondary group cursor-pointer inline-flex items-center justify-center gap-3 w-full sm:w-fit"
              >
          ...
          <AnimatedWrapper delay={0.65}>
            <div className="mt-6 md:mt-8 p-4 glass-card">
              <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-xs md:text-sm text-gray-300">
      ...
      <div className="absolute bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 md:w-8 md:h-12 border-2 border-cyan-500/50 rounded-full flex justify-center relative">
          <div className="w-1 h-3 bg-cyan-400 rounded-full mt-2 md:mt-3 animate-pulse shadow-lg shadow-cyan-400/50"></div>
