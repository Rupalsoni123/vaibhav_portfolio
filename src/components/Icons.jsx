...
function GitHub({ width = 18, height = 18, className = "" }) {
    return (
...
function Telegram() {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 448 512" >
            <path fill="#03A9F4"
...
function Resume() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115.34 122.88" width="17" height="17" >
            <path fill="currentColor"
...
function Map() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 232597 333333" height="20" width="20">
            <path
                fill="#1a73e8"
...
function Chat() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.88" width="20" height="20">
            <path
                fill="#1A73E8"
...
// Loader Icon
function Loader({ size = 24, color = "currentColor", className = "" }) {
  return (
    <svg 
      width={size} 
      height={size} 
...
// Sun Icon
function Sun({ size = 24, color = "currentColor", className = "" }) {
  return (
    <svg 
      width={size} 
      height={size} 
...
// Moon Icon
function Moon({ size = 24, color = "currentColor", className = "" }) {
  return (
    <svg 
      width={size} 
      height={size} 
