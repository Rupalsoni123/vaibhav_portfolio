...
const GCP = ({ width = 45, height = 45 }) => {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path fill="#EA4335" d="M15.082 7.575 16.797 5.86 16.91 5.137C13.792 2.302 8.836 2.625 6.026 5.808a8.16 8.16 0 0 0-1.793 3.205l.61-.086 3.43-.566.265-.27a4.554 4.554 0 0 1 6.183-.482z" />
      <path fill="#4285F4" d="M19.282 8.964a8.16 8.16 0 0 0-2.464-3.971l-2.41 2.41a4.514 4.514 0 0 1 1.655 3.583v.43a2.252 2.252 0 0 1 2.244 2.255 2.252 2.252 0 0 1-2.244 2.244h-4.522l-.451.456v2.708l.45.43h4.523a5.857 5.857 0 0 0 5.974-5.806 5.835 5.835 0 0 0-2.755-4.74z" />
      <path fill="#34A853" d="M7.748 20.451h4.508V16.83H7.749a2.222 2.222 0 0 1-.93-.204l-.64.198-1.722 1.715-.15.609a5.835 5.835 0 0 0 3.441 1.302z" />
      <path fill="#FBBC05" d="M7.749 8.74a5.835 5.835 0 0 0-3.523 10.467l2.62-2.62a2.244 2.244 0 1 1 2.97-2.97l2.62-2.62A5.835 5.835 0 0 0 7.748 8.74z" />
    </svg>
  );
};
...
const Oracle = ({ width = 60, height = 45 }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        fill="#C74634"
        d="M110.412 21.063h13.554l-7.166-11.527-13.155 20.84H97.62L113.626 5.27c.683-.999 1.852-1.595 3.122-1.595 1.235 0 2.405.583 3.075 1.564l16.06 25.137h-6.025l-2.825-4.665h-13.74zm83.42 4.661V0h-5.107v27.866c0 .662.262 1.288.749 1.78.493.49 1.16.762 1.871.762h27.039l3.028-4.684zm-89.964-5.286c5.116 0 9.252-4.137 9.252-9.252 0-5.115-4.136-9.252-9.252-9.252H81.43v25.71h5.105V8.624h17.022a4.566 4.566 0 0 1 4.566 4.563 4.563 4.563 0 0 1-4.566 4.566l-14.5-.014L104.79 29.55h7.41l-9.916-9.117zM12.86 29.382c-7.101 0-12.86-5.749-12.86-12.85S5.76 3.67 12.86 3.67h14.94c7.1 0 12.857 5.76 12.857 12.86 0 7.103-5.757 12.85-12.858 12.85zm14.601-4.683a8.166 8.166 0 0 0 8.17-8.166 8.166 8.166 0 0 0-8.17-8.176H13.2a8.165 8.165 0 0 0-8.16 8.176 8.165 8.165 0 0 0 8.16 8.166h14.261zm123.367 4.683c-7.1 0-12.858-5.749-12.858-12.85s5.758-12.86 12.858-12.86h17.737l-3.014 4.684h-14.396a8.165 8.165 0 0 0-8.16 8.176 8.165 8.165 0 0 0 8.16 8.166h17.674l-3.025 4.684zm75.842-4.683c-3.598 0-6.633-2.42-7.567-5.73h21.197l3.024-4.683H218.97a7.84 7.84 0 0 1 7.566-5.72H241.16l3.014-4.683h-17.965c-7.1 0-12.858 5.76-12.858 12.86 0 7.103 5.758 12.85 12.858 12.85h15.43l3.025-4.683H226.67z"
      />
    </svg>
  );
};

const DigitalOcean = ({ width = 45, height = 45 }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        fill="#0080FF"
        d="M16.005 32v-6.198c6.564 0 11.654-6.504 9.135-13.408a9.244 9.244 0 0 0-5.541-5.539C12.69 4.345 6.193 9.434 6.193 16h-6.19C-.003 5.541 10.107-2.605 21.072.81c4.789 1.495 8.62 5.317 10.107 10.106C34.6 21.881 26.464 32 16.005 32z"
      />
      <path fill="#0080FF" d="M16.025 25.83H9.86v-6.165h6.165zM9.86 30.566H5.117v-4.738H9.86zm-4.743-4.738H1.144v-3.97h3.973z" />
    </svg>
  );
};
